...
public class FileUploadServiceImpl implements FileUploadService {
    ...
    @Override
    public String uploadFileService(MultipartFile file) throws IOException {
        ...
        try {
            ...
            if (response.sdkHttpResponse().isSuccessful()) {
                return "https://" + bucketName + ".s3.amazonaws.com/" + key;  // 👈 fixed
            } else {
    ...
    @Override
    public boolean deleteFileService(String imgUrl) {
